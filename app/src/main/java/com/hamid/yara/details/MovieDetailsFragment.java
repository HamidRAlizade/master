...
import com.hamid.yara.BaseApplication;
...
public class MovieDetailsFragment extends Fragment implements MovieDetailsView, View.OnClickListener
{
    ...
    @Override
    public void showTrailers(Video trailers)

    {
        Glide.with(getContext()).load(trailers.getPoster()).into(poster);
//
        title.setText(trailers.getTitle());
        releaseDate.setText(String.format(getString(R.string.release_date), trailers.getYear()));
        rating.setText(String.format(getString(R.string.rating), String.valueOf(trailers.getImdbRating())));
        overview.setText(trailers.getPlot());
//
